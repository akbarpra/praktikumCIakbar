...
<body style="background: linear-gradient(135deg, #325adf 0%, #e7530f 100%);">
	<header class="ob">
		<div class="atas">
			<div id="logo"><img style="width: 170px; margin-left: 40px; float: left;" src="<?=base_url()?>assets/logo.png" alt=""> </div>
				<nav>
				<ul>
	...
	<h1 align="center" style="color: skyblue; text-align: left; font-size: 10.3mm; margin-top: 97px; margin-left: 12px; font-family: sans-serif;"> Selamat Datang Akbar <br> Berperilakulah seperti Laki - Laki </h1>

	<p style="font-size: 18px; margin-left: 56px; margin-top: 39px;">Halo Akbar.. Pagi ini kamu terlihat keren sekali.. semoga bahagia selamanya! </p>
